	...
	return (
		<div className="privacy">
			...
			<div className="privacy-text">
				...
				<p>Welcome to Unison!</p>

				<p>
					These terms and conditions outline the rules and regulations for the use of
					Unison's Website, located at Unison.com.
				</p>

				<p>
					By accessing this website we assume you accept these terms and conditions.
					Do not continue to use Unison if you do not agree to take all of the terms
				...
				<p>
					We employ the use of cookies. By accessing Unison, you agreed to use
					cookies in agreement with the Unison's Privacy Policy.{" "}
				</p>
				...
				<p>
					Unless otherwise stated, Unison and/or its licensors own the intellectual
					property rights for all material on Unison. All intellectual property
					rights are reserved. You may access this from Unison for your own personal
					use subjected to restrictions set in these terms and conditions.
				</p>

				<p>You must not:</p>
				<ul>
					<li>Republish material from Unison</li>
					<li>Sell, rent or sub-license material from Unison</li>
					<li>Reproduce, duplicate or copy material from Unison</li>
					<li>Redistribute content from Unison</li>
				</ul>
				...
				<p>
					...
					opinions and information in certain areas of the website. Unison does not
					filter, edit, publish or review Comments prior to their presence on the
					website. Comments do not reflect the views and opinions of Unison,its
					...
					applicable laws, Unison shall not be liable for the Comments or for any
				...
				<p>
					Unison reserves the right to monitor all Comments and to remove any
				...
				<p>
					You hereby grant Unison a non-exclusive license to use, reproduce, edit and
				...
				<p>
					...
					compensates the absence of Unison; and (d) the link is in the context of
				...
				<p>
					...
					e-mail to Unison. Please include your name, your organization name, contact
				...
				<p>
					No use of Unison's logo or other artwork will be allowed for linking absent
